...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    /// </summary>
    public class CassiaPointerMediator : IMixedRealityPointerMediator
    {
        ...
        public CassiaPointerMediator()
            : this(null)
        {
        }

        public CassiaPointerMediator(IPointerPreferences pointerPrefs)
        {
            pointerPreferences = pointerPrefs;
        }

        private static readonly ProfilerMarker RegisterPointersPerfMarker = new ProfilerMarker("[MRTK] CassiaPointerMediator.RegisterPointers");
        ...
        public virtual void RegisterPointers(IMixedRealityPointer[] pointers)
        {
            using (RegisterPointersPerfMarker.Auto())
            {
                for (int i = 0; i < pointers.Length; i++)
                {
                    ...
                    else if(pointer is IMixedRealityToolPointer)
                    {
        ...
        private static readonly ProfilerMarker UnregisterPointersPerfMarker = new ProfilerMarker("[MRTK] CassiaPointerMediator.UnregisterPointers");
        ...
        private static readonly ProfilerMarker UpdatePointersPerfMarker = new ProfilerMarker("[MRTK] CassiaPointerMediator.UpdatePointers");
        ...
        private static readonly ProfilerMarker ApplyCustomPointerBehaviorsPerfMarker = new ProfilerMarker("[MRTK] CassiaPointerMediator.ApplyCustomPointerBehaviors");
        ...
        private static readonly ProfilerMarker ApplyPointerBehaviorPerfMarker = new ProfilerMarker("[MRTK] CassiaPointerMediator.ApplyPointerBehavior");
